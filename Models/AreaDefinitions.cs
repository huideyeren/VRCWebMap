...
public static class AreaDefinitions
{
    ...
    [
        ...
        new(AreaCodes.Japan.Mie, "三重県", AreaCategory.Chubu),
        new(AreaCodes.Japan.Shiga, "滋賀県", AreaCategory.Kansai),
        new(AreaCodes.Japan.Kyoto, "京都府", AreaCategory.Kansai),
        new(AreaCodes.Japan.Osaka, "大阪府", AreaCategory.Kansai),
        new(AreaCodes.Japan.Hyogo, "兵庫県", AreaCategory.Kansai),
        new(AreaCodes.Japan.Nara, "奈良県", AreaCategory.Kansai),
        new(AreaCodes.Japan.Wakayama, "和歌山県", AreaCategory.Kansai),
